...
activate :s3_sync do |s3_sync|
  ...
  s3_sync.delete                = PRODUCTION ? true : false
...
# Redirects for old Squarespace blog

# S3 Routing rules to redirect the RSS feed:
# <RoutingRules>
#     <RoutingRule>
#         <Condition>
#             <KeyPrefixEquals>blog?format=rss</KeyPrefixEquals>
#         </Condition>
#         <Redirect>
...
redirect '/blog/2013/4/2/how-to-not-make-an-argument', '/'
redirect '/blog/2013/4/2/why-users-have-no-power', '/'
redirect '/blog/2013/4/2/the-lack-of-self-knowledge-in-tv-movies', '/'
...
redirect '/blog/2013/4/21/auto-layout-performance-on-ios', '/2013/04/22/auto-layout-performance-on-ios/'
...
redirect '/blog/2013/5/11/backstage-with-nested-managed-object-contexts', '/2013/05/13/backstage-with-nested-managed-object-contexts/'
...
redirect '/blog/2013/6/5/uikonf-presentation-app-optimization-with-instruments', '/2013/06/05/uikonf-presentation-app-optimization-with-instruments/'
redirect '/blog/2013/6/7/announcing-objcio', '/2013/06/07/announcing-objcio/'
...
redirect '/blog/2014/2/18/alt-tech-talks-london-one-cannot-not-communicate', '/2014/02/18/alt-tech-talks-london-one-cannot-not-communicate/'
redirect '/blog/2014/4/6/deckset-has-launched', '/2014/04/07/deckset-has-launched/'
